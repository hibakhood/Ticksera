      ...
      <section className="relative overflow-hidden bg-white dark:bg-slate-900">
        ...
        <div className="s-hero s-inner relative z-10 max-w-6xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-500" style={{ marginBottom: '1.5rem' }}>
            ...
            <span className="text-slate-900 dark:text-slate-300">Terms of Service</span>
          </div>
            ...
            <main className="flex-1 min-w-0">
              ...
              <div className="rounded-3xl bg-slate-50 dark:bg-slate-950 relative overflow-hidden text-center px-6 py-12 sm:px-12 border border-slate-200 dark:border-slate-800" style={{ marginTop: '2.5rem' }}>
                ...
                <div className="relative z-10">
                  <h3 className="font-heading text-slate-900 dark:text-white" style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '0.75rem' }}>The fine print, minus the friction.</h3>
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                    ...
                    <Link to="/pricing">
                      <Button variant="ghost" size="lg" className="text-slate-600 hover:text-slate-900 hover:bg-slate-100 dark:text-slate-400 dark:hover:text-white dark:hover:bg-slate-800">View Pricing</Button>
                    </Link>
                  </div>
                </div>
              </div>
